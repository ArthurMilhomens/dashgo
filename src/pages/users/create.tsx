...
const createUserFormSchema = yup.object().shape({
  ...
  password: yup.string().required('Senha obrigatória').min(6, 'Mínimo de 6 carácteres'),
        ...
        <Box as="form" onSubmit={handleSubmit(handleCreateUser)} flex="1" borderRadius={8} bg="gray.800" p={["6", "8"]}>
          ...
          <VStack spacing="8">
            ...
            <SimpleGrid minChildWidth="240px" spacing={["6", "8"]} w="100%">
              ...
              <Input name="password_confimation" type="password" label="Confirmação da senha" error={formState.errors.password_confirmation} {...register('password_confirmation')}/>
            </SimpleGrid>
          </VStack>
          ...
          <Flex mt="8" justify="flex-end">
            <HStack spacing="4">
              ...
              <Button type="submit" isLoading={formState.isSubmitting} colorScheme="green">Salvar</Button>
            </HStack>
          </Flex>
        </Box>
      </Flex>
